 ...
 * @date 25/04/2017
 */
public class ExperimentoIEEEMOEADNSM extends Experiment {
...
//            algorithm[3] = new MOEAD_M_Configuracoes(problemName, maxGeracoes).configure(parameters[3]);
            ...
            Logger.getLogger(ExperimentoIEEEMOEADNSM.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void executar() throws JMException, IOException {
        ExperimentoIEEEMOEADNSM exp = new ExperimentoIEEEMOEADNSM();
