 ...
 * @author Deyvid
 */
class MOEAD_M_Configuracoes extends Settings {

    public int maxGeracoes;

    public MOEAD_M_Configuracoes(String problem, int maxGeracoes) {
        super(problem);
    ...
    public Algorithm configure() throws JMException {
        ...
        algorithm.setInputParameter("populacaoQtdSPEA2", UtilAP.calcularPorcentagem(0, populacaoTotal));
        algorithm.setInputParameter("populacaoTchebyCheff", UtilAP.calcularPorcentagem(120, populacaoTotal));
