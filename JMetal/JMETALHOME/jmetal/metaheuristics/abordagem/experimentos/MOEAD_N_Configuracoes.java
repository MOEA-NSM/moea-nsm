 ...
 * @author Deyvid
 */
class MOEAD_N_Configuracoes extends Settings {

    public int maxGeracoes;

    public MOEAD_N_Configuracoes(String problem, int maxGeracoes) {
        super(problem);
    ...
    public Algorithm configure() throws JMException {
        ...
        algorithm.setInputParameter("populacaoQtdNSGAII", UtilAP.calcularPorcentagem(120, populacaoTotal));
