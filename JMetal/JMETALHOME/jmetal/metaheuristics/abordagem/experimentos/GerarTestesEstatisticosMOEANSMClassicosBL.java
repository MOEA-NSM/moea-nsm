 ...
 * @date 25/04/2017
 */
public class GerarTestesEstatisticosMOEANSMClassicosBL extends Experiment {
    ...
    public synchronized void algorithmSettings(String problemName, int problemIndex, Algorithm[] algorithm)
        ...
        try {
            ...
            Logger.getLogger(GerarTestesEstatisticosMOEANSMClassicosBL.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void executar() throws JMException, IOException {
        GerarTestesEstatisticosMOEANSMClassicosBL exp = new GerarTestesEstatisticosMOEANSMClassicosBL();
...
//        exp.algorithmNameList_ = new String[]{"MOEANSM"};
        exp.algorithmNameList_ = new String[]{"SPEA2", "SPEA2BL", "NSGAII", "NSGAIIBL", "MOEAD", "MOEADBL", "ABNSGAIISPEA2MOEADBL"};
