 ...
 * @date 25/04/2017
 */
public class GerarTestesEstatisticosMOEANSM extends Experiment {
...
//            algorithm[3] = new MOEAD_M_Configuracoes(problemName, maxGeracoes).configure(parameters[3]);
            ...
            Logger.getLogger(GerarTestesEstatisticosMOEANSM.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void executar() throws JMException, IOException {
        GerarTestesEstatisticosMOEANSM exp = new GerarTestesEstatisticosMOEANSM();
...
//        exp.algorithmNameList_ = new String[]{"MOEANSM"};
        exp.algorithmNameList_ = new String[]{"MOEANSM", "MOEAN", "MOEAS", "MOEAM"};
        ...
        exp.experimentBaseDirectory_ = "C:\\Users\\Deyvid\\Dropbox\\EXPERIMENTOSMOEADNSM25042017";
