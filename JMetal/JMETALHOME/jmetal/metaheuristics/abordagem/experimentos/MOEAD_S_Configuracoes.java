...
import jmetal.metaheuristics.abordagem.moeansm.MoeaNSM;
 ...
 * @author Deyvid
 */
class MOEAD_S_Configuracoes extends Settings {

    public int maxGeracoes;

    public MOEAD_S_Configuracoes(String problem, int maxGeracoes) {
        super(problem);
    ...
    public Algorithm configure() throws JMException {
        ...
        algorithm.setInputParameter("populacaoQtdNSGAII", UtilAP.calcularPorcentagem(0, populacaoTotal));
        algorithm.setInputParameter("populacaoQtdSPEA2", UtilAP.calcularPorcentagem(120, populacaoTotal));
        algorithm.setInputParameter("populacaoTchebyCheff", UtilAP.calcularPorcentagem(0, populacaoTotal));
