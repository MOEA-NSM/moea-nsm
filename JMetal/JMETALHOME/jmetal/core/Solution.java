...
public class Solution implements Serializable {
    ...
    private Integer objetivoBuscaLocal;
    ...
    public Solution(Problem problem, int[] solucao) throws ClassNotFoundException {
        problem_ = problem;
        type_ = problem.getSolutionType();
        numberOfObjectives_ = problem.getNumberOfObjectives();
        objective_ = new double[numberOfObjectives_];
    ...
    //<-
        ...
        //variable_ = problem.solutionType_.createVariables() ; 
        variable_ = type_.createVariables(solucao);
    } // Solution
    ...
    public Solution(Solution solution) {
        ...
        objetivoBuscaLocal = solution.getObjetivoBuscaLocal();
    } // Solution
    ...
    /*Calcula o fitness de todos os objetivos - Ponderado*/
    public double getFitnessMeuPonderado() {
        double soma = 0;
        for (int i = 0; i < this.numberOfObjectives_; i++) {
            soma = soma + this.getObjective(i);
        }
        return soma;
    } // getFitness
    
    /*Calcula o fitness de acordo com o objetivo passado*/
    public double getFitnessMeuPorObjetivo(int objetivo) {
            return this.getObjective(objetivo);
    } // getFitness
    ...
    public Integer getObjetivoBuscaLocal() {
        return objetivoBuscaLocal;
    }

    public void setObjetivoBuscaLocal(Integer objetivoBuscaLocal) {
        this.objetivoBuscaLocal = objetivoBuscaLocal;
    }

    @Override
    public int hashCode() {
        int hash = 7;
        hash = 89 * hash + Arrays.hashCode(this.objective_);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Arrays.equals(this.objective_, other.objective_)) {
            return false;
        }
        return true;
    }
